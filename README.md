...
This [Cordova plugin](https://www.npmjs.com/package/cordova-plugin-swift-support) adds the Swift support to your iOS project.
...
`<dependency id="cordova-plugin-swift-support" version="2.0.2"/>`
